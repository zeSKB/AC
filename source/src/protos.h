...
struct servercommandline
{
    ...
    const char *ip, *master, *logident, *serverpassword, *adminpasswd, *demopath, *maprot, *pwdfile, *blfile, *nbfile, *infopath, *motdpath, *killmessages, *demofilenameformat, *demotimestampformat;
